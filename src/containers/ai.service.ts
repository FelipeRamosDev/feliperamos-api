...
import AICoreInputCell from '../services/AICore/models/AICoreInputCell';
import { AICoreCellSetup } from '../services/AICore/AICore.types';
...
//    turn.setInstructions('Minha renda mensal é de R$ 15.000,00.');
//    turn.addCell('user', userInput);

//    turn.stream((text) => process.stdout.write(text)).then((result) => {
//       console.log('\n-----------------------------------------------------------------------------\n\n');
//    }).catch(console.error);
// });
