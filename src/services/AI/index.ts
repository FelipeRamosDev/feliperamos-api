...
import type { AIOptions, CreateResponseOpt, ResponseInput } from './AI.types.ts';
...
export default class AI {
   ...
   public useAssistant: boolean;


   constructor (apiKey: string, options?: AIOptions) {
      ...
      this.useAssistant = Boolean(this._assistantID);
   ...
   async threadMessage(threadID: string, message: string) {
      if (!this.useAssistant || this._assistantID === undefined) {
